    ...
    <div class="card w-8/12 mx-12">
        <div class="card-body">
            <x-form wire:submit.prevent="submit">
                ...
                <x-select label="Select Group" icon="o-users" option-value="id" :options="$groups" wire:model="selectedGroup" inline/>
                <x-select label="Select Teacher" icon="o-user-circle" option-value="id" :options="$users" wire:model="selectedUser" inline/>
