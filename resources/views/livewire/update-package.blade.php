    ...
    <div class="card w-8/12 mx-12">
        <div class="card-body">
            <x-form wire:submit.prevent="submit">
                ...
                <x-input wire:model="count_lesson" label="Lessons" type="count_lesson" class="form-control" id="count_lesson"
                         placeholder="Enter lessons total count"/>
                <x-input wire:model="price" label="Price" type="price" class="form-control" id="price" placeholder="Enter price"/>
